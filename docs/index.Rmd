...
The event logging data was extracted from the database using the following SQL query:
...
<ol><li id="ref-1"><a href = "https://www.mediawiki.org/wiki/Wikimedia_Discovery/Search/Glossary">Discovery's Glossary</a> on Wikimedia Discovery/Search/Glossary</li></ol>
